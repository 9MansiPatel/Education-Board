...
/**
 * Servlet implementation class StudentDiscussionBoardServlet
 */
@WebServlet("/StudentDiscussionBoardServlet")
public class StudentDiscussionBoardServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public StudentDiscussionBoardServlet() {
        super();
