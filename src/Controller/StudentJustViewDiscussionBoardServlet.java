...
/**
 * Servlet implementation class StudentJustViewDiscussionBoardServlet
 */
@WebServlet("/StudentJustViewDiscussionBoardServlet")
public class StudentJustViewDiscussionBoardServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public StudentJustViewDiscussionBoardServlet() {
        super();
...
HttpSession session = request.getSession(false);
		...
		String sql= "SELECT * FROM (SELECT User_id,Course_name, Post, DATE(Post_time) AS DATE FROM discussion_board ORDER BY DATE ASC) T WHERE Course_name='"+s2+"'";
